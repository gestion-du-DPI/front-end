      ...
      <div class="flex flex-grow items-center justify-center">
        <div class="w-full max-w-4xl bg-white py-8 px-6 border-2 rounded-2xl border-[#F4F2F2] shadow-lg">
          ...
          <div class="flex justify-end mt-8 space-x-4">
            <button class=" bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 flex items-center gap-2 px-4 py-2 whitespace-nowrap h-auto" (click)="onPres()">
            <img src="previous-icon.svg" alt="" class="w-4 h-4" />
...
export class EditProfileComponent {
  ...
  onPres(): void {
    this.router.navigate(['/patient/consultation-details']);
  }
