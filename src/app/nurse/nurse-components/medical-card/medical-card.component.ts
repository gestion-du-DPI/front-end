...
import { MedicalTest } from '../../../models/medical-card-nurse';
      ...
      <div class="card-content p-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            >
              <img
                src="nurse-icons/blue-lab.png"
                alt="icon"
                [class.hidden]="test.priority != 'low'"
              />
              <img
                src="nurse-icons/red-lab.png"
                alt="icon"
                [class.hidden]="test.priority != 'Critical'"
              />
              <img
                src="nurse-icons/orange-lab.png"
                alt="icon"
            ...
            <div>
              ...
              >
                <img src="nurse-icons/user-icon.png" alt="icon" />
                {{ test.doctor }}
              </div>
            </div>
          </div>
          <div class="flex items-center gap-2">
            ...
            >
              <img
                src="nurse-icons/chevron-down-icon.png"
                alt="icon"
                [class.hidden]="isExpanded"
              />
              <img
                src="nurse-icons/chevron-up-icon.png"
                alt="icon"
                [class.hidden]="!isExpanded"
              />
            </button>
            ...
            >
              <img
                src="nurse-icons/plus-icon.png"
                alt="icon"
                [class.hidden]="isSelected"
                class="w-4 h-4"
              />
              <img
                src="nurse-icons/pinned-icon.png"
                alt="icon"
                [class.hidden]="!isSelected"
                class="w-4 h-4"
              />
