...
import { LabTechnicianTicketService } from '../../../services/tickets/lab-technician-ticket/lab-technician-ticket.service';
...
export class TicketsHistoryComponent implements OnInit {
  ...
  constructor(private ticketService: LabTechnicianTicketService) {}
