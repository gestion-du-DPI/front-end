...
@Component({
  ...
  template: `
    <div class="bg-[#393E9F] text-white transition-all duration-300 flex flex-col justify-between h-full"
      [class.w-16]="isSidebarCollapsed" [class.w-48]="!isSidebarCollapsed"
      (click)="toggleSidebar()" [ngClass]="{'w-16': isSidebarCollapsed, 'w-48': !isSidebarCollapsed}">
