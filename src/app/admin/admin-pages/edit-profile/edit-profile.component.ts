    ...
    <div class="flex flex-col min-h-screen bg-gray-50">
      <div class="flex flex-col gap-4 lg:mx-16 mx-3">
        <div class="flex flex-col lg:flex-row justify-between items-center gap-4">
          <div class="p-4">
            <h1 class="text-2xl lg:text-3xl text-main font-semibold">Edit Profile</h1>
          </div>
        ...
        <div class="w-full max-w-4xl bg-white py-8 px-6 border-2 rounded-2xl border-[#F4F2F2] shadow-lg">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-7 space-y-4">
              ...
              <div class="space-y-4">
                <div class="relative">
                  <img src="edit-name.svg" alt="User Icon" class="absolute left-3 top-2.5 w-6 h-6" />
                  <input type="text" placeholder="Full Name" class="pl-12 w-full border border-gray-300 py-3 rounded-md" />
                </div>
                <div class="relative">
                  <img src="edit-hospital.svg" alt="Hospital Icon" class="absolute left-3 top-2.5 w-6 h-6" />
                  <input type="text" placeholder="Hospital Name" class="pl-12 w-full border border-gray-300 py-3 rounded-md" />
                </div>
                <div class="relative">
