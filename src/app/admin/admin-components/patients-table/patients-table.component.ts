    ...
    <table class="border-collapse justify-self-center table-auto w-full">
      <thead>
        <tr>
          ...
          <th>Email Address</th>
          <th>Phone Number</th>
          <th class="hidden lg:table-cell">Social Security Number (NSS)</th>
          <th class="hidden lg:table-cell">Address</th>
          <th class="hidden lg:table-cell">Emergency Contact</th>
          <th class="hidden lg:table-cell">Emergency Phone</th>
        ...
        <tr *ngFor="let patient of patients" class="hover:bg-slate-50">
          <td class="flex flex-row gap-4 items-center">
            <img
              ...
              alt="Profile Picture"
              (click)="onProfilePictureClick(patient.name)"
            />
...
export class PatientsTableComponent {
  ...
  onCancelEdit() {
    ...
    this.selectedPatient = null; // Clear the selected patient
  }
