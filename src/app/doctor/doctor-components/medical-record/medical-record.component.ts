...
import { Consultation } from '../../../models/doc-getDPI';
      ...
      >
        <div class="flex flex-row">
          ...
          >
            ...
            >
              {{ consultation.date | date : 'yyyy-MM-dd' }}
            </div>
            ...
            <div class="flex flex-col w-full">
              ...
              <ng-container [ngSwitch]="consultation.sgph">
                <span
  ...
  ngOnInit(): void {
    ...
    if (patientId) {
      this.patientService.getDPIById(patientId).subscribe({
        next: (data) => {
          this.consultations = data.consultations_list;
